...
void loadSounds() {
    @g_ak1Sound = Audio::LoadSample("sounds/do.wav");
    @g_ak2Sound = Audio::LoadSample("sounds/sol.wav");
    @g_ak3Sound = Audio::LoadSample("sounds/si.wav");
    @g_ak4Sound = Audio::LoadSample("sounds/mi.wav");
    @g_ak5Sound = Audio::LoadSample("sounds/sol2.wav");
}
